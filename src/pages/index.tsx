              ...
              <div className="m-auto">
                  <div className="text-indigo-500 text-center">
                      ...
                      <div className="m-auto space-x-4 mt-2 ">
                          <button className="text-white bg-green-600 text-sm p-2 rounded-full transition hover:bg-green-700 w-44 text-base font-semibold " type="button" onClick={(() => void handleGameStart("easy"))} >Easy</button>
                          <button className="text-white bg-orange-600 text-sm p-2 rounded-full transition hover:bg-orange-700 w-44 text-base font-semibold " type="button" onClick={(() => void handleGameStart("medium"))}>Medium</button>
                      ...
                      <div className="m-auto space-x-4 mt-5 ">
                          <button className="text-white bg-emerald-700 text-sm p-2 rounded-full transition hover:bg-emerald-800 w-44 text-base font-semibold " type="button" onClick={(() => void handleGameStart("arts_and_literature"))}>Art and literature</button>
                          <button className="text-white bg-amber-800 text-sm p-2 rounded-full transition hover:bg-amber-900 w-44 text-base font-semibold " type="button" onClick={(() => void handleGameStart("food_and_drink"))}>Food and Drink</button>
                          <button className="text-white bg-lime-700 text-sm p-2 rounded-full transition hover:bg-lime-800 w-44 text-base font-semibold" type="button" onClick={(() => void handleGameStart("geography"))}>Geography</button>
                          <button className="text-white bg-fuchsia-700 text-sm p-2 rounded-full transition hover:bg-fuchsia-800 w-44 text-base font-semibold" type="button" onClick={(() => void handleGameStart("history"))}>History</button>
                      </div>
